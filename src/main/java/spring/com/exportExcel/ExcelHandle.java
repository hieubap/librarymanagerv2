package spring.com.exportExcel;

import spring.com.entity.Student;
...
public class ExcelHandle {
    ...
    public static void excelTest() throws IOException {
        ...
        list.add(new Student(1,"hieu","2018"));
        list.add(new Student(2,"hieu","2018"));
        list.add(new Student(3,"hieu","2018"));
